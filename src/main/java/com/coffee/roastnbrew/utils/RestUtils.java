...
import com.coffee.roastnbrew.exceptions.APIUnavailableException;
...
public class RestUtils {
    ...
    public static Response request(String url, String method, String payload,
        ...
        try {
            ...
            throw new APIException(Response.Status.GATEWAY_TIMEOUT.getStatusCode(), "");
        } catch (IOException e) {
    ...
    protected static Response getResponse(HttpURLConnection conn) throws IOException, APIUnavailableException {
        ...
        if (responseCode >= 200 && responseCode < 300) {
            ...
            throw new APIUnavailableException(responseCode);
        } else {
